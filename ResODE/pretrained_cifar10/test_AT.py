...
def eval_training(epoch=0, tb=True, before = False):
    ...
    for (images, labels) in cifar100_test_loader:
        if args.gpu:
            ...
            '''
            images_fgsm = atk_fgsm_fixed(images, labels).cuda()
    ...
    if before == False : 
        ...
        print('Evaluating Network right after breaching. . . .')
...
if __name__ == '__main__':
    ...
    for epoch in range(1, settings.EPOCH + 1):
        ...
        if epoch % 5 == 0 : 
            ...
            eval_training(epoch, before = True)

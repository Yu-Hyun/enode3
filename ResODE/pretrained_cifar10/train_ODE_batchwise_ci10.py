...
if __name__ == '__main__':
    ...
    for epoch in range(1, 10 + 1):
        ...
        atk_fgsm_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_pgd_test_avg = pgd(model = net_avg.eval(), steps=20)
        atk_pgd_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_cw_test_avg = CW(model = net_avg.eval())
        atk_cw_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_mifgsm_test_avg = MIFGSM(model = net_avg.eval())
        atk_mifgsm_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_tifgsm_test_avg = TIFGSM(model = net_avg.eval())
        atk_tifgsm_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_difgsm_test_avg = DIFGSM(model = net_avg.eval())
        atk_difgsm_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_nifgsm_test_avg = NIFGSM(model = net_avg.eval())
        atk_nifgsm_test_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        
        
        atk_fgsm_avg = torchattacks.FGSM_avg(fixed_model_list)
        atk_fgsm_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
        
        atk_pgd_avg = torchattacks.PGD_avg(fixed_model_list)
        atk_pgd_avg.set_normalization_used(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616]) 
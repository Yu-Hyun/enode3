...
def train(epoch):
    ...
    mean=torch.tensor([0.5070751592371323, 0.48654887331495095, 0.4409178433670343]).cuda()
    std=torch.tensor([0.2673342858792401, 0.2564384629170883, 0.27615047132568404]).cuda()
    net.train()
...
if __name__ == '__main__':
    ...
    atk_fgsm_train.set_normalization_used(mean=[0.5070751592371323, 0.48654887331495095, 0.4409178433670343], std=[0.2673342858792401, 0.2564384629170883, 0.27615047132568404]) # svhn 

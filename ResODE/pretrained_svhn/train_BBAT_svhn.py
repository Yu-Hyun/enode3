...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16':
        ...
        net = vgg16_bn()
        net.load_state_dict(torch.load('/home/kimin.yun/yh/svhn/svhn_pretrained/vgg16-200-regular.pth'))
    elif args.net == 'resnet18':
        from models.resnet import resnet18
        net = resnet18()
        net.load_state_dict(torch.load('/home/kimin.yun/yh/svhn/svhn_pretrained/resnet18-200-regular.pth'))
    elif args.net == 'inceptionv3':
        from models.inceptionv3 import inceptionv3
        net = inceptionv3()
        net.load_state_dict(torch.load('/home/kimin.yun/yh/svhn/svhn_pretrained/inceptionv3-200-regular.pth'))
        ...
        net.load_state_dict(torch.load('/home/kimin.yun/yh/svhn/svhn_pretrained/inceptionresnetv2-200-regular.pth'))
    elif args.net == 'wideresnet':
        from models.wideresidual import wideresnet
        net = wideresnet()
        net.load_state_dict(torch.load('/home/kimin.yun/yh/svhn/svhn_pretrained/wideresnet-200-regular.pth'))

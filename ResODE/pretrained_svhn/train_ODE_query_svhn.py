...
def train(epoch):
    ...
    for batch_index, (images, labels) in enumerate(cifar100_training_loader):
        ...
        if batch_index % 6 == 0:
            ...
            torch.save(g1, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_g1')
            torch.save(V1, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_g2')
            torch.save(V1, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_V1')
            torch.save(G1, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_G1')
            torch.save(V01, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_V01')
            torch.save(G01, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_G01')
            torch.save(V2, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_V1')
            torch.save(G2, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_G2')
            torch.save(V02, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_V02')
            torch.save(G02, weights_path + '_batch_' + str(batch_index) + '_epoch_'+str(epoch) +'_G02')
